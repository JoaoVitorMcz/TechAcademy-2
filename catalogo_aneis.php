<?php
    ...
    $produtos_aneis = [
        ["id" => 1, "nome" => "Anel Solitário Clássico", "preco" => "129,90", "imagem" => "https://placehold.co/300x300/FDF8E1/777?text=Anel+Solitário", "descricao" => "Um clássico atemporal, perfeito para todas as ocasiões."],
