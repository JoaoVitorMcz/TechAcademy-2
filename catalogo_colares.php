<?php
    ...
    $produtos_colares = [
        ...
        ["id" => 15, "nome" => "Gargantilha Coração Pedra Esmeralda", "preco" => "159,90", "imagem" => "https://placehold.co/300x300/FDF8E1/888?text=Colar+Cora%C3%A7%C3%A3o", "descricao" => "Romântico e delicado, perfeito para presentear alguém especial."],
        ["id" => 16, "nome" => "Gargantilha Flor Cravejada", "preco" => "168,00", "imagem" => "https://placehold.co/300x300/FCEFB4/444?text=Colar+P%C3%A9rola", "descricao" => "Elegância atemporal com pérola sintética de alta qualidade."],
    ];
?>
