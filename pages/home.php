        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 p-3 rounded">
                    ...
                    <a href="catalogo_todos" class="btn btn-primary">Descubra Nossas Novidades</a>
                </div>
            </div>
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="catalogo_aneis" class="btn btn-primary mt-auto align-self-start">Ver Anéis</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="catalogo_colares" class="btn btn-primary mt-auto align-self-start">Ver Colares</a>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-lg-4"> <div class="card h-100 shadow">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="catalogo_pulseiras" class="btn btn-primary mt-auto align-self-start">Ver Pulseiras</a>
                    </div>
                </div>
            </div>
        </div>
